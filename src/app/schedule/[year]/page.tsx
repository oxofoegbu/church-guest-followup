        ...
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          ...
          {scheduleYear.theme && (
            <div style={{ background: 'rgba(255,255,255,0.1)', borderRadius: 12, padding: '12px 20px', display: 'inline-block', marginBottom: 16 }}>
              <p style={{ margin: 0, fontSize: 15, opacity: 0.9, fontStyle: 'italic' }}>
                {scheduleYear.theme}
              </p>
            </div>
          )}
                      ...
                      return (
                        <div key={svc.id} style={{ background: '#fff', borderRadius: 10, border: '1px solid #e5e7eb', padding: 14, boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }}>
                          ...
                          <div style={{ borderTop: '1px solid #f0f0f0', paddingTop: 8, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6, fontFamily: 'sans-serif' }}>
                            {[
                              { icon: '🎤', label: 'Speaker', val: speaker },
                              { icon: '📋', label: 'Coord.', val: coord },
                              { icon: '🙏', label: 'Prayer', val: prayer },
                              { icon: '🎵', label: 'Worship', val: worship },
                            ].map(({ icon, label, val }) => (
                              <div key={label}>
                          ...
                          {svc.notes && (
                            <p style={{ margin: '8px 0 0', fontSize: 11, color: '#92400e', background: '#fef3c7', padding: '4px 8px', borderRadius: 4, fontFamily: 'sans-serif' }}>
                              📌 {svc.notes}
                            </p>
                          )}
                        </div>
