...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://gracelifecenter.com/begin',
    ...
    images: [
      { url: 'https://gracelifecenter.com/begin/social-og.jpg', width: 1200, height: 630 },
      { url: 'https://gracelifecenter.com/begin/social-square.jpg', width: 1254, height: 1254 },
    ],
  },
  twitter: {
    ...
    description:
      'A place to begin \u2014 with Jesus, and with us. The Welcome Track is a short, unhurried journey. You\u2019re welcome here.',
    images: ['https://gracelifecenter.com/begin/social-og.jpg'],
  },
};
