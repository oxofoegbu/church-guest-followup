...
// Run 31 / Run 47 — Contact message form. Posts to /api/contact, then confirms
// the sender's email with a 6-digit code (OtpDialog) before the message reaches
// the church inbox. Honeypot guard.
